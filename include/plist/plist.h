...
#ifdef WIN32
	#define libplist_DLL_EXPORT __declspec(dllexport)
	#define libplist_DLL_IMPORT __declspec(dllimport)
#else
	#define libplist_DLL_EXPORT __attribute__ ((visibility ("default")))
	#define libplist_DLL_IMPORT __attribute__ ((visibility ("default")))
#endif

#ifdef libplist_DLL // defined if compiled as a dynamic lib
	#ifdef libplist_DLL_EXPORTS // defined if building a dynamic lib
		#define libplist_API libplist_DLL_EXPORT
	#else
		#define libplist_API libplist_DLL_IMPORT
	#endif
#else
	#define libplist_API
#endif
...
#include <stdarg.h>
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_dict(void);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_array(void);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_string(const char *val);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_bool(uint8_t val);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_uint(uint64_t val);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_real(double val);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_data(const char *val, uint64_t length);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_date(int32_t sec, int32_t usec);
     ...
     * @sa #plist_type
     */
    libplist_API plist_t plist_new_uid(uint64_t val);
     ...
     */
    libplist_API void plist_free(plist_t plist);
     ...
     * @return copied plist
     */
    libplist_API plist_t plist_copy(plist_t node);
     ...
     */
    libplist_API uint32_t plist_array_get_size(plist_t node);
     ...
     */
    libplist_API plist_t plist_array_get_item(plist_t node, uint32_t n);
     ...
     */
    libplist_API uint32_t plist_array_get_item_index(plist_t node);
     ...
     */
    libplist_API void plist_array_set_item(plist_t node, plist_t item, uint32_t n);
     ...
     */
    libplist_API void plist_array_append_item(plist_t node, plist_t item);
     ...
     */
    libplist_API void plist_array_insert_item(plist_t node, plist_t item, uint32_t n);
     ...
     */
    libplist_API void plist_array_remove_item(plist_t node, uint32_t n);
     ...
     */
    libplist_API uint32_t plist_dict_get_size(plist_t node);
     ...
     */
    libplist_API void plist_dict_new_iter(plist_t node, plist_dict_iter *iter);
     ...
     */
    libplist_API void plist_dict_next_item(plist_t node, plist_dict_iter iter, char **key, plist_t *val);
     ...
     */
    libplist_API void plist_dict_get_item_key(plist_t node, char **key);
     ...
     *		the returned node.
     */
    libplist_API plist_t plist_dict_get_item(plist_t node, const char* key);
     ...
     */
    libplist_API void plist_dict_set_item(plist_t node, const char* key, plist_t item);
    ...
    libplist_API void plist_dict_insert_item(plist_t node, const char* key, plist_t item);
     ...
     */
    libplist_API void plist_dict_remove_item(plist_t node, const char* key);
     ...
     */
    libplist_API void plist_dict_merge(plist_t *target, plist_t source);
     ...
     */
    libplist_API plist_t plist_get_parent(plist_t node);
     ...
     */
    libplist_API plist_type plist_get_node_type(plist_t node);
     ...
     */
    libplist_API void plist_get_key_val(plist_t node, char **val);
     ...
     */
    libplist_API void plist_get_string_val(plist_t node, char **val);
     ...
     */
    libplist_API void plist_get_bool_val(plist_t node, uint8_t * val);
     ...
     */
    libplist_API void plist_get_uint_val(plist_t node, uint64_t * val);
     ...
     */
    libplist_API void plist_get_real_val(plist_t node, double *val);
     ...
     * @param length the length of the buffer
     */
    libplist_API void plist_get_data_val(plist_t node, char **val, uint64_t * length);
     ...
     */
    libplist_API void plist_get_date_val(plist_t node, int32_t * sec, int32_t * usec);
     ...
     * @param val a pointer to a uint64_t variable.
     */
    libplist_API void plist_get_uid_val(plist_t node, uint64_t * val);
     ...
     */
    libplist_API void plist_set_key_val(plist_t node, const char *val);
     ...
     *		freed by the node.
     */
    libplist_API void plist_set_string_val(plist_t node, const char *val);
     ...
     */
    libplist_API void plist_set_bool_val(plist_t node, uint8_t val);
     ...
     * @param val the unsigned integer value
     */
    libplist_API void plist_set_uint_val(plist_t node, uint64_t val);
     ...
     * @param val the real value
     */
    libplist_API void plist_set_real_val(plist_t node, double val);
     ...
     * @param length the length of the buffer
     */
    libplist_API void plist_set_data_val(plist_t node, const char *val, uint64_t length);
     ...
     * @param usec the number of microseconds
     */
    libplist_API void plist_set_date_val(plist_t node, int32_t sec, int32_t usec);
     ...
     * @param val the unsigned integer value
     */
    libplist_API void plist_set_uid_val(plist_t node, uint64_t val);
     ...
     */
    libplist_API void plist_to_xml(plist_t plist, char **plist_xml, uint32_t * length);
     ...
     * @param length a pointer to an uint32_t variable. Represents the length of the allocated buffer.
     */
    libplist_API void plist_to_bin(plist_t plist, char **plist_bin, uint32_t * length);
     ...
     */
    libplist_API void plist_from_xml(const char *plist_xml, uint32_t length, plist_t * plist);
     ...
     * @param plist a pointer to the imported plist.
     */
    libplist_API void plist_from_bin(const char *plist_bin, uint32_t length, plist_t * plist);
     ...
     */
    libplist_API plist_t plist_access_path(plist_t plist, uint32_t length, ...);
     ...
     * @return the value to access.
     */
    libplist_API plist_t plist_access_pathv(plist_t plist, uint32_t length, va_list v);
     ...
     */
    libplist_API char plist_compare_node_value(plist_t node_l, plist_t node_r);
